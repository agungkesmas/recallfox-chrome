...
export function onSyncChange(callback) {
  // v3.22.5-firefox FIX-2: storage.sync.onChanged adalah API CHROME-ONLY.
  // Firefox hanya punya browser.storage.onChanged (global, semua area) —
  // akses storage.sync.onChanged melempar TypeError di Firefox dan
  // mematikan background saat load. Gunakan listener global + filter area.
...
// User bisa klik kanan pada video → "Blokir Konten Ini" untuk
