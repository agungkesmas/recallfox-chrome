...
// Schema per note (v3.21.20 — P1-P4 + dueAt + labels + done + subtasks):
//   {
...
export async function getNotes() {
  ...
  // v3.21.20: migrasi subtasks + done/doneAt/priority/dueAt/labels untuk notes lama
  notes = notes.map(n => {
    const base = { done: false, doneAt: null, priority: 4, dueAt: null, labels: [], subtasks: [], ...n };
