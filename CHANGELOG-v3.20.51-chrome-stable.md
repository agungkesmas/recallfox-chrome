# RecallFox v3.20.51-chrome-stable — CHECKPOINT

**Release date:** 2026-08-07
**Tag:** `v3.20.51-chrome-stable` (CHECKPOINT — stable release)
...
# Chrome
git clone https://github.com/agungkesmas/recallfox-chrome.git
cd recallfox-chrome-chrome
git checkout v3.20.51-chrome-stable
```

## Versi dev setelah checkpoint ini

Setelah v3.20.51-chrome-stable, versi dev berikutnya akan mulai dari v3.20.52-dev. Kalau ada regression di versi dev, user bisa selalu rollback ke v3.20.51-chrome-stable.
